...
\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
\033[1;94m ┈┈┈┈╲┊┊┊┊╱┈┈┈┈\033[1;94mmuhammadmadni.\033[1;91m┈┈┈┈╲┊┊┊┊╱┈┈┈┈
\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈
\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲
\033[1;96m................\033[1;93mmuhammadmadni\033[1;91m...............
\033[1;96m................\033[1;93m✬🄵🄰🄲🄴🄱🄾🄾🄺✬\033[1;91m..............

\033[1;96m░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░

\033[1;91m☞ Auther     : B4_madni_M4_MASTER
\033[1;92m☞ WhatsApp   : 03317355151
...
def menu():
	...
	print (S + '[' + P + '☞3' + S + ']' + S + ' B4_madni WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/B4_gulfad')
	    os.system('cd $HOME && git clone https://github.com/muhammadmadni786/gulfad')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WhatsApp Num 03317355151✓')
	    psb('WellCome To B4_madni')
	    psb('Congratulations B4_madni Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ madni786✓')
	    psb('🔓Password ☆ 445566✓')
...
def pb():
	...
	print(S+50*'-')
	print
	print(S+'Process has been completed CP ID Open After 1 Days ')
	print(Y+'Total '+G+'OK'+S+'/'+P+'CP'+S+' = '+G+str(len(oks))+S+'/'+R+str(len(cps)))
	print(S+'BlackMafia')     
	print
	raw_input(R + 'Back')
	os.system('python2 gulfad.py')
